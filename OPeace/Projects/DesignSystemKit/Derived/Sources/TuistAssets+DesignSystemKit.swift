...
public enum DesignSystemKitAsset {
  ...
  public static let graySacleB = DesignSystemKitColors(name: "GraySacle.B")
    public static let grayScaleW = DesignSystemKitColors(name: "GrayScale.W")
    public static let grayScale100 = DesignSystemKitColors(name: "GrayScale100")
    public static let grayScale200 = DesignSystemKitColors(name: "GrayScale200")
    public static let grayScale300 = DesignSystemKitColors(name: "GrayScale300")
  ...
  public static let imgBackgroundGradientGreenDot = DesignSystemKitImages(name: "Img.Background.Gradient.Green.Dot")
    ...
    public static let imgOpeaceSplashLogo = DesignSystemKitImages(name: "Img.Opeace.Splash.Logo")
  }
}
